...
const QUESTIONS: {
  ...
  {
    question:
      "빅데이터 마이크로디그리(MD)는 빅데이터표준 MD와 연계융합표준 MD, 이렇게 두 종류로 구성되어 있다.",
    answer: "O",
    explanation:
      "빅데이터 마이크로디그리(MD)는 빅데이터 전공 교과목 중심인 빅데이터표준 MD와 각 학부/과의 전공 과목과 결합한 연계융합표준 MD로 구성되어 있습니다.",
  },
  {
    question:
      "빅데이터표준 MD는 3학점짜리 빅데이터 전공 교과목 4개를 수강하면 이수할 수 있다.",
    answer: "O",
    explanation:
      "빅데이터표준 MD는 빅데이터 전공 교과목(3학점) 4개를 수강하여 총 12학점을 이수할 시 취득할 수 있습니다.",
  },
  {
    question:
